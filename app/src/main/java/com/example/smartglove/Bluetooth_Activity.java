...
public class Bluetooth_Activity extends AppCompatActivity {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (inputLayout.getEditText().getText().toString().equals("")) {
                    Toast.makeText(Bluetooth_Activity.this, "Por favor insira algum texto", Toast.LENGTH_SHORT).show();
                } else {
                    //TODO: here
        ...
        switch (requestCode) {
            case REQUEST_ENABLE_BLUETOOTH:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(this, "\n" +
                            "Bluetooth ainda desativado, desligue o aplicativo!", Toast.LENGTH_SHORT).show();
                    finish();
                }
        }
    }
    ...
    private void sendMessage(String message) {
        if (chatController.getState() != ChatController.STATE_CONNECTED) {
            Toast.makeText(this, "Conexão foi perdida!", Toast.LENGTH_SHORT).show();
            return;
        }
